<?php
/**
 * Template Name: Home: Slideshow 2 (585x305)
 * @package WordPress
 */
...
get_header(); ?>
		...
		<li class="feature-item-<?php echo $count;?> flex-slider-item">			
			<a href="<?php the_permalink();?>"><?php the_post_thumbnail('featured-2');?></a>
			<p class="flex-caption">
				<a href="<?php the_permalink();?>"><?php if($feature_title !== '') { echo $feature_title; }else{ echo get_the_title(); } ?></a>
			</p><!-- end .flex-caption -->
		</li><!-- end .feature-item -->						
