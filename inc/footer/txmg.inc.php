<div id="about">
			<div class="about">			
				...
				<ul>
					...
					<li><a href="http://txmg.org/future-events/">Master Gardener Events</a></li>
					<li><a href="http://txmg.org/contacts/by-county/">Chapter By County</a></li>					
					<li class="last"><a href="http://txmg.org/contacts/program-coordinator/">Contact Us</a></li>										
				</ul>				
			</div><!-- .about -->
		</div><!-- #about -->	
