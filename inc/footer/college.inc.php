<div id="about">
			<div class="about">			
				<h4>About</h4>
				<a href="http://www.youtube.com/watch?v=NrfZh8t443M"><img src="<?php bloginfo( 'template_directory' ); ?>/images/college-video.jpg?v=100" alt="link to College about video" /></a>
		...
		<div id="popular-links">
			<div class="popular-links">			
				<h4>Departments</h4>
				<a href="http://aglifesciences.tamu.edu/"><img src="<?php bloginfo( 'template_directory' ); ?>/images/Agriculture_HQ.jpg?v=100" alt="Texas A and M Ag Life Sciences" /></a>	
				<ul>
		...
		<div id="texas-a-m">
			...
			<h4>Required Links</h4>
				<a href="http://www.tamu.edu"><img src="<?php bloginfo( 'template_directory' ); ?>/images/texas-a-m-logo.png?v=100" alt="Texas A&amp;M University" /></a>
				<ul>
