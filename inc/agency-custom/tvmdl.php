...
function agriflex_tvmdl_logo() {
  ...
  $html .= '</span>';
  $html .= '<img src="' . get_bloginfo( 'stylesheet_directory') . '/img/tvmdl-branding.png" alt="Texas A&amp;M Research Logo" />';
  $html .= '</a>';
  $html .= '</li>';
...
function tvmdl_about( $about ) {
  ...
  $html = '<h4>About</h4>';
  $html .= '<a href="http://www.youtube.com/watch?v=7Cdai78sCPw"><img src="' . get_bloginfo( 'template_directory' ) . '/img/about_video_tvmdl.jpg?v=100" alt="link to TVMDL about video" /></a>';
...
function tvmdl_links( $links ) {
  ...
  $html .= '<a href="http://agrilifeextension.tamu.edu/"><img src="' . get_bloginfo( 'template_directory' ) . '/img/agrilife_tvmdl_logo.png?v=100" alt="TVMDL" /></a>	';
  $html .= '<ul>';
