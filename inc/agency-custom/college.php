...
function college_about( $about ) {
  ...
  $html = '<h4>About</h4>';
  $html .= '<a href="http://www.youtube.com/watch?v=NrfZh8t443M"><img src="' . get_template_directory_uri() . '/img/college-video.jpg?v=100" alt="link to College about video" /></a>';
...
function college_required_logo( $link_logo ) {
  ...
  $link_logo .= '<img src="' . get_template_directory_uri() . '/img/texas-a-m-logo.png?v=100" alt="Texas A&amp;M University image" />';
  $link_logo .= '</a>';
