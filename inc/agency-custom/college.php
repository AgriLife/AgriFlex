...
function agriflex_college_logo() {
  ...
  $html .= '</span>';
  $html .= '<img src="' . get_bloginfo( 'stylesheet_directory') . '/img/college-branding.png" alt="Texas A&amp;M College Logo" />';
  $html .= '</a>';
  $html .= '</li>';
...
function college_links( $links ) {
  ...
  $html .= '<a href="http://aglifesciences.tamu.edu/"><img src="' . get_bloginfo( 'template_directory' ) . '/img/Agriculture_HQ.jpg?v=100" alt="Texas A and M Ag Life Sciences" /></a>	';
  $html .= '<ul>';
...
function college_required_logo( $link_logo ) {
  ...
  $link_logo .= '<img src="' . get_bloginfo( 'template_directory' ) . '/img/texas-a-m-logo.png?v=100" alt="Texas A&amp;M University image" />';
  $link_logo .= '</a>';
