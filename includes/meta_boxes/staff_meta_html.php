	...
	<input type="text" class="admin-form-input" id="course_5" name="_my_meta[course_5]" value="<?php if(!empty($meta['course_5'])) echo $meta['course_5']; ?>" placeholder="e.g. Research and Evaluation" size="40" /></p>	
